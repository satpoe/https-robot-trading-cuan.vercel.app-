  ...
  <main>
    ...
    <section id="page-settings" class="hidden">
      ...
      <div class="card"><div class="card-head"><h2>Risk & Strategy</h2></div><div class="card-body">
        ...
        <br>
        <div class="notice">Dashboard ini adalah frontend. Untuk data broker yang benar-benar live dan eksekusi order, diperlukan koneksi backend/API ke MT5 atau broker. Jangan memasukkan password akun trading ke file HTML ini.</div>
